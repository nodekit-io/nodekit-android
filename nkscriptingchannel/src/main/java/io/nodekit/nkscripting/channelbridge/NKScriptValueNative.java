...
class NKScriptValueNative extends NKScriptValueImpl {
    ...
    NKScriptValueNative(String ns, NKScriptChannel channel, int instanceid, Object[] args, boolean create)  {
        ...
        this._channel = channel;
        this._instanceid = instanceid;
        Class cls = channel.typeInfo.NJSgetType();
        ...
        NKScriptValueImpl promise = null;
   ...
   /* protected NKScriptValueNative(String ns, NKScriptChannel channel)  {
    ...
    private NKScriptInvocation bindObject(Object obj) {
        ...
        NKScriptValueImpl.setForObject(obj, this);
        return proxy;
    }
    ...
    private void unbindObject(Object obj) throws Exception {
        ...
        nativeObject = null;
        NKScriptValueImpl.setForObject(obj, null);
        proxy = null;
    }

    void invokeNativeMethod(String method, Object[] args, ValueCallback<String> callback) {
        if (proxy == null)
        {
            return;
        }
    ...
    private Object wrapScriptObject(Object obj)
    {
        ...
        if (obj instanceof Map<?,?>)
        {
            ...
            if (dict.containsKey("$sig") && ((Integer)dict.get("$sig")) == 0x5857574F)
            {
                ...
                return new NKScriptValueImpl(num, this.context, this);
            }
            ...
            if (dict.containsKey("$ns"))
            {
                ...
                if (ns != null)
                    return new NKScriptValueImpl(ns, this.context, this);
            }
        }
    ...
    public void invokeMethod(String method, Object[] args, ValueCallback<String> completionHandler) {
