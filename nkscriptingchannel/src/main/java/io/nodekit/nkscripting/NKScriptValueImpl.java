...
public class NKScriptValueImpl implements NKScriptValue {

    public String namespace;

    public NKScriptContext context;

    protected NKScriptValueImpl _origin = null;
    ...
    public NKScriptValueImpl() {}

    public NKScriptValueImpl(String namespace, NKScriptContext context)   {
        this.namespace = namespace;
        this.context = context;
    }


    public NKScriptValueImpl(String namespace, NKScriptContext context, NKScriptValueImpl origin)
    {
        this.namespace = namespace;
        this.context = context;
        if (origin != null)
    ...
    public NKScriptValueImpl(int reference, NKScriptContext context, NKScriptValueImpl origin)
    {
    ...
    @Override
    public void hasProperty(String property, ValueCallback<String> completionHandler) {
    ...
    private void evaluateExpression(String expression, ValueCallback<String> completionHandler )
    {
        try {
    ...
    public static NKScriptValueImpl getForObject(Object obj)
    {
    ...
    public static void setForObject(Object obj, NKScriptValueImpl value)
    {
        if (value != null)
