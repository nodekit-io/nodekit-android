...
[![JitPack compatible](https://img.shields.io/badge/jcenter-hosted-4BC51D.svg?style=flat-square)](https://bintray.com/beta/#/nodekit-io/maven/nkscripting?tab=overview)
...
This repository requires [`git-lfs`](https://github.com/git-lfs/git-lfs/wiki/Installation) for cloning and building.
...
dependencies {
    implementation fileTree(dir: 'libs', include: ['*.jar'])
     implementation 'io.nodekit:engine-common:3.0.2'
      implementation
      'io.nodekit:engine-jsc:3.0.2'
    implementation 'io.nodekit:nkscripting:3.0.2'
    implementation 
}
```
...
## News
* (September 2019) 3.0 Added external engines; included JavaScriptCore; published to JCenter instead of Jitpack 
