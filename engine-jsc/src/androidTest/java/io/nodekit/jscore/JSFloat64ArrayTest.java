...
public class JSFloat64ArrayTest {
    ...
    public void testJSFloat64Array() throws Exception {
        ...
        assertEquals(array.property("BYTES_PER_ELEMENT").jsvalueToNumber().intValue(),8);
        ...
        assertEquals(context.property("Float64a").jsvalueToObject().getClass(),JSFloat64Array.class);
        ...
        assertTrue(last1.equals(2.0));
        assertTrue(list.get(1).equals(20.0));
        ...
        it.next();
        it.set(100.0);
        assertTrue(list.get(0).equals(100.0));
