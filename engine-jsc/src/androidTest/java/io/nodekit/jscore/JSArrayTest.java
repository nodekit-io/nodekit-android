...
public class JSArrayTest {
    ...
    public void testJSArrayConstructors() throws Exception {
        ...
        assertThat(array.get(0).jsvalueToNumber().intValue(),is(1));
        ...
        assertThat(array3.get(1).jsvalueIsStrictEqual(2),is(true));
        assertThat(array3.get(2).jsvalueIsStrictEqual("three"),is(true));
    ...
    public void testJSArrayListMethods() throws Exception {
        ...
        assertTrue(((JSValue) list.get(4)).jsvalueIsObject());
        ...
        assertTrue(((JSValue) array[4]).jsvalueIsObject());
    ...
    public void testJSArrayJSMethods() throws Exception {
        ...
        bar.property("_from", new JSFunction(context,"_from") {
            ...
            public String _from(String currentValue, int index) {
                return getThis().property("string").jsvalueToJSArray().get(index).toString();
            }
        });
        JSArray<JSValue> from4 = JSArray.from(context,foo,bar.property("_from").jsvalueToFunction(),bar);
        String [] BAR = { "B", "A", "R" };
        ...
        int inventoryCount = inventoryMap
                .reduce(new JSArray.ReduceCallback() {
                    ...
                    public JSValue callback(JSValue jsValue, JSValue jsValue1, int i,
                        ...
                        return new JSValue(context,jsValue.jsvalueToNumber() + jsValue1.jsvalueToNumber());
                    }
        ...
        String dateLocale = date.property("toLocaleString").jsvalueToFunction().call(date).toString();
        assertEquals(locale.toLocaleString(),"1337," + dateLocale + ",foo");

        // Array.prototype.values()
        Iterator<String> values = keysArr.values();
        assertEquals(values.next(),"Zero");
        assertEquals(values.next(),"One");
        assertEquals(values.next(),"undefined");
