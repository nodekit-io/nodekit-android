...
public class JSUint8ClampedArrayTest {
    ...
    public void testJSUint8ClampedArray() throws Exception {
        ...
        JSUint8ClampedArray i8 = new JSUint8ClampedArray(context,8);
        for (byte i=0; i<8; i++) i8.set(i,i);
        JSUint8ClampedArray array2 = new JSUint8ClampedArray(i8);
        for (int i=0; i<8; i++)
            assertEquals(array2.get(i),Byte.valueOf((byte)i));

        List<Integer> ai = Arrays.asList(0,1,2,3,4,5,6,7);
        JSUint8ClampedArray array3 = new JSUint8ClampedArray(context,ai);
        ...
        JSUint8ClampedArray ab = new JSUint8ClampedArray(context,8);
        for (int i=0; i<8; i++) ab.set(i,(byte)i);

        @SuppressWarnings("MismatchedQueryAndUpdateOfCollection")
        JSUint8ClampedArray array4 = new JSUint8ClampedArray(ab.buffer(),4,2);
        assertThat(array4.size(),is(2));
        assertThat(array4.get(0),is((byte)4));
        assertThat(array4.get(1),is((byte)5));

        @SuppressWarnings("MismatchedQueryAndUpdateOfCollection")
        JSUint8ClampedArray array5 = new JSUint8ClampedArray(ab.buffer(),6);
        assertThat(array5.size(),is(2));
        assertThat(array5.get(0),is((byte)6));
        assertThat(array5.get(1),is((byte)7));

        @SuppressWarnings("MismatchedQueryAndUpdateOfCollection")
        JSUint8ClampedArray array6 = new JSUint8ClampedArray(ab.buffer());
        ...
        JSUint8ClampedArray array7 = new JSUint8ClampedArray(context,Arrays.asList(5,4,3,2,1));
        JSUint8ClampedArray array8 = array7.subarray(0,2);
        assertThat(array8.size(),is(2));
        assertThat(array8.get(0),is((byte)5));
        assertThat(array8.get(1),is((byte)4));

        JSUint8ClampedArray array9 = array7.subarray(2);
        ...
        context.evaluateScript("var uint8clampeda = new Uint8ClampedArray(10);");
        assertEquals(context.property("uint8clampeda").jsvalueToObject().getClass(),JSUint8ClampedArray.class);

        List<Byte> list = new JSUint8ClampedArray(context, Arrays.asList(1,2,3,4,5));
        ...
        @SuppressWarnings("MismatchedQueryAndUpdateOfCollection")
        List<Byte> list2 = new JSUint8ClampedArray(context,0);
        ...
        list = new JSUint8ClampedArray(context,Arrays.asList(0,1,2,3,0,1,2,3));
